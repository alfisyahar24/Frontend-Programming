 ...
 */
const users = [
  { name: "Alfi", age: 20, major: "Informatics Engineering" },
  { name: "Fauzan", age: 21, major: "Business and Management" },
  { name: "Agung", age: 22, major: "Psychology" },
  { name: "Rayhan", age: 23, major: "Industrial Engineering" },
  { name: "Jiddan", age: 24, major: "Public Relation" },
];
